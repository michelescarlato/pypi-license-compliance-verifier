...
licenses = ["AFL", "AGPL", "Apache", "Artistic", "BSD", "BSL", "bzip2", "CC0", "CDDL", "CPE", "CPL", "curl", "EFL",
            "EPL", "EUPL", "FTL", "GPL", "HPND", "IBM", "ICU", "IJG", "IPL", "ISC",
            "LGPL", "Libpng", "libtiff", "MirOS", "MIT", "CMU", "MPL", "MS", "NBPL", "NTP", "OpenSSL", "OSL", "Python",
            "Qhull", "RPL", "SunPro", "Unicode", "UPL", "WTFPL", "X11", "XFree86", "Zlib", "zlib-acknowledgement"]
...
DynamicMappingKeywordsList = [
    "a", "2007", "2010", "2014", "academic", "affero", "agpl", "apache", "attribution", "beer"
                                                                                        "berkeley", "by", "bsd", "bzip",
    "cc", "cecill", "classpath", "clear", "clause", "cmu", "cpe", "commons", "creative",
    ...
    "mpl", "nc", "nd", "ntp", "new", "nuclear", "national", "only", "open", "openssl", "patent", "pddc", "psf", "psfl",
    "python",
